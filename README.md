...
Also with this, the database user and password are no longer just `root` anymore as everything is set in the `.env`, hence why the `config.php` file also needs to be updated.